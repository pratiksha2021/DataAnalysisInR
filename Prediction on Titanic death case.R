...
#Read the dataset----
titanic<-read.csv("C:/Users/Predator/R program/Analytics_R/data/titanic.csv",header=TRUE)
...
library(rpart.plot)
#Decision Tree
fit <- rpart(survived~., data = trainData, method = 'class', control = rpart.control(minsplit =20))
rpart.plot(fit)
